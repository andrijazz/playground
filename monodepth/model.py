...
class Monodepth(object):
    ...
    def __build_model(self):
        ...
        with tf.variable_scope('decoder', reuse=self.reuse_variables):
            self.h_upconv7 = tf_utils.deconv_layer(name='upconv7', in_ch=512, out_ch=512, kernel_size=3, stride=2, relu=False, batch_norm=False, x=self.h_conv7b)                              # h / 64
            ...
            self.h_upconv6 = tf_utils.deconv_layer(name='upconv6', in_ch=512, out_ch=512, kernel_size=3, stride=2, relu=False, batch_norm=False, x=self.h_iconv7)                              # h / 32
            ...
            self.h_upconv5 = tf_utils.deconv_layer(name='upconv5', in_ch=512, out_ch=256, kernel_size=3, stride=2, relu=False, batch_norm=False, x=self.h_iconv6)                              # h / 16
            ...
            self.h_upconv4 = tf_utils.deconv_layer(name='upconv4', in_ch=256, out_ch=128, kernel_size=3, stride=2, relu=False, batch_norm=False, x=self.h_iconv5)                              # h / 8
            # paper err in_ch = 128
            ...
            self.h_upconv3 = tf_utils.deconv_layer(name='upconv3', in_ch=128, out_ch=64, kernel_size=3, stride=2, relu=False, batch_norm=False, x=self.h_iconv4)                               # h / 4
            ...
            self.h_upconv2 = tf_utils.deconv_layer(name='upconv2', in_ch=64, out_ch=32, kernel_size=3, stride=2, relu=False, batch_norm=False, x=self.h_iconv3)                                # h / 2
            ...
            self.h_upconv1 = tf_utils.deconv_layer(name='upconv1', in_ch=32, out_ch=16, kernel_size=3, stride=2, relu=False, batch_norm=False, x=self.h_iconv2)                                # h
