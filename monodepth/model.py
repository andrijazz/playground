...
class Monodepth(object):
    ...
    def __build_model(self):
        ...
        with tf.variable_scope('decoder', reuse=self.reuse_variables):
            self.h_upconv7 = tf_utils.deconv_layer(name='upconv7', in_ch=512, out_ch=512, kernel_size=3, stride=2, relu=False, elu=True, batch_norm=False, x=self.h_conv7b)                              # h / 64
            ...
            self.h_upconv6 = tf_utils.deconv_layer(name='upconv6', in_ch=512, out_ch=512, kernel_size=3, stride=2, relu=False, elu=True, batch_norm=False, x=self.h_iconv7)                              # h / 32
            ...
            self.h_upconv5 = tf_utils.deconv_layer(name='upconv5', in_ch=512, out_ch=256, kernel_size=3, stride=2, relu=False, elu=True, batch_norm=False, x=self.h_iconv6)                              # h / 16
